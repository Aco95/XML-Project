...
public class Korisnik {
	...
	public Korisnik(List<Smestaj> smestaji, List<Poruka> poslatePoruke, List<Poruka> primljenePoruke,
			List<Rezervacija> rezervacije, String ime, String prezime, Uloga uloga, String email, String username,
			String password, String maticniBroj, String adresa, boolean blokiran) {
		super();
		this.smestaji = smestaji;
		this.poslatePoruke = poslatePoruke;
		this.primljenePoruke = primljenePoruke;
